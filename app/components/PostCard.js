export function PostCard (props){
    ...
    let imgPost = _links["wp:featuredmedia"]? _links['wp:featuredmedia'][0].href : "app/assets/img/Walk-logo.png";
    //console.log(_links["wp:featuredmedia"][0].href) // No sé la url de la img
    ...
    <img src="${imgPost}" width="200px" alt="${title.rendered}">
